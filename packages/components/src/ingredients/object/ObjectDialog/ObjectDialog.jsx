  ...
  return (
    <Dialog open={open} onClose={onClose} aria-labelledby="form-dialog-title">
      <form onSubmit={handleSubmit(submit)}>
        ...
        <DialogContent>
          <DialogContentText>
            An object is a container for a group of properties related to one
            another. You'll be able to drag items from the ingredients list into
            it.
          </DialogContentText>
          <TextField
            control={control}
            ...
            rules={{
              ...
              pattern: {
                value: /^[a-z0-9_]*$/,
                message:
                  "Must contain only lowercase letters, numbers and underscores (so-called 'snake_case')",
              },
            }}
          />
          <TextField
