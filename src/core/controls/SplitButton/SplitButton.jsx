...
SplitButton.propTypes = {
  ...
  selected: (props, propName) => {
    if (!Number.isInteger(props.selected) || (props.selected < 0) || (props.selected >= props.options.length)) {
      return new Error(`${propName} (current value = ${props.selected}) needs to be a valid index into the options array, or the options array must be of length >= 1`)
    }
    return null
  },
  /**
